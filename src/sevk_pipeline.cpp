...
namespace sevk
{
    ...
    SevkPipeline::~SevkPipeline() 
    {
        vkDestroyShaderModule(sevkDevice.device(), vertexShaderModule, nullptr);
        vkDestroyShaderModule(sevkDevice.device(), fragmentShaderModule, nullptr);
        vkDestroyPipeline(sevkDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    )
    {
        ...
        createShaderModule(vertex_code, &vertexShaderModule);  // fills the vertex shader module with the code.
        createShaderModule(fragment_code, &fragmentShaderModule);  // fills the fragment shader module with the code.

        VkPipelineShaderStageCreateInfo shaderStages[2];
        shaderStages[0].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO; 
        shaderStages[0].stage = VK_SHADER_STAGE_VERTEX_BIT;
        shaderStages[0].module = vertexShaderModule;
        shaderStages[0].pName = "main";  // this is the name of the main shader function.
        ...
        shaderStages[1].pName = "main";  // this is the name of the main shader function.
        shaderStages[1].flags = 0;
        shaderStages[1].pNext = nullptr;
        shaderStages[1].pSpecializationInfo = nullptr;

        // defining how the shaders will be interpreted
